 ...
 */
@FunctionalInterface
public interface Slot7<T, U, V, W, X, Y, Z> extends Slot {
    ...
    @NotNull
    default Slot7<T, U, V, W, X, Y, Z>
    andThen(@NotNull final Slot7<? super T, ? super U, ? super V, ? super W,
            ? super X, ? super Y, ? super Z> after) {
